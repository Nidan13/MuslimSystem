...
@section('title', 'Modify Quest Category')
...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-6 mb-10">
        ...
        <div>
            <h1 class="text-4xl font-serif font-black text-teal-900 tracking-wide uppercase">Modify Taxonomy</h1>
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-[0.4em]">Updating classification node: {{ $questType->name }}</p>
        </div>
    </div>
