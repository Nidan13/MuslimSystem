...
@section('title', 'Daftarkan Kategori Quest')
...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-6 mb-10">
        ...
        <div>
            <h1 class="text-4xl font-serif font-black text-teal-900 tracking-wide uppercase">Taksonomi Baru</h1>
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-[0.4em]">Inisialisasi klasifikasi misi baru</p>
        </div>
    </div>
            ...
            <div class="grid grid-cols-2 gap-10">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" rows="5" 
                        ...
                        placeholder="Tentukan perilaku dan lingkup kategori quest ini...">{{ old('description') }}</textarea>
                </div>
            </div>
