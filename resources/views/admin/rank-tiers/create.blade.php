...
@section('title', 'Tambah Pangkat Baru')
...
<div class="w-full animate-fadeIn pb-20">
    ...
    <div class="flex items-center gap-8 mb-12">
        ...
        <div>
            <h1 class="text-3xl font-serif font-black text-teal-950 uppercase tracking-tight">Tambah Pangkat Baru</h1>
    ...
    <div class="glass-panel p-1 rounded-[45px] bg-white border-2 border-slate-100 shadow-2xl shadow-slate-200/50 overflow-hidden relative">
        <div class="absolute -right-20 -top-20 w-80 h-80 bg-teal-400/5 rounded-full blur-[100px] pointer-events-none group-hover:bg-cyan-400/10 transition-colors"></div>
        
        <form action="{{ route('admin.rank-tiers.store') }}" method="POST" class="relative z-10">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 p-8 bg-slate-50/50 rounded-[32px] border border-slate-100 shadow-inner">
                    <div class="space-y-6">
                        ...
                        <div class="relative">
                            <input type="text" name="slug" value="{{ old('slug') }}" required 
                                class="w-full bg-white border-2 border-slate-100 rounded-[24px] text-teal-900 p-8 focus:border-cyan-400 focus:ring-4 focus:ring-cyan-500/5 outline-none transition-all font-serif font-black text-5xl text-center uppercase shadow-sm" placeholder="E">
                    ...
                    <div class="space-y-6">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required 
                            class="w-full bg-white border-2 border-slate-100 rounded-[24px] text-teal-950 p-8 focus:border-cyan-400 focus:ring-4 focus:ring-cyan-500/5 outline-none transition-all font-serif font-black text-2xl uppercase tracking-tighter shadow-sm" placeholder="MISAL: HUNTER PEMULA">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                     <div class="md:col-span-1 space-y-6">
                        ...
                        <div class="flex items-center gap-4 p-4 bg-slate-50 rounded-[24px] border-2 border-slate-100 shadow-inner">
                            ...
                            <div class="flex-1">
                                <span class="block text-[10px] font-black text-teal-950 font-mono tracking-tighter">KODE WARNA</span>
                    ...
                    <div class="md:col-span-2 space-y-6">
                        ...
                        <textarea name="description" rows="3" 
                            class="w-full bg-slate-100/50 border-2 border-slate-100 rounded-[24px] text-slate-600 p-6 outline-none focus:border-cyan-400 focus:bg-white transition-all font-medium text-sm shadow-inner leading-relaxed" placeholder="Tuliskan deskripsi atau cerita untuk pangkat ini..."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="p-10 bg-teal-950/5 border-t-2 border-slate-50 flex items-center justify-between">
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] max-w-sm italic">
                    Menambahkan pangkat baru akan memperluas hierarki dan target pencapaian Hunter.
                </p>
