...
@section('title', 'Authority Tier Manifestation')
...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-6 mb-10">
        ...
        <div>
            <h1 class="text-4xl font-serif font-black text-teal-900 tracking-wide uppercase">Manifest Authority</h1>
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-[0.4em] mt-2 flex items-center gap-2">
                <span class="w-2 h-2 rounded-full bg-cyan-400 animate-pulse"></span>
                Establishing New Rank Tier in System Hierarchy
            </p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.rank-tiers.store') }}" method="POST" class="space-y-10 relative z-10">
            ...
            <div class="space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div>
                        <label class="block text-[10px] font-black text-teal-900/40 uppercase mb-3 tracking-[0.3em] ml-1">Rank Slug (e.g. S, A, B)</label>
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required 
                            class="w-full bg-slate-50 border-2 border-slate-200 rounded-[24px] text-teal-900 p-6 focus:border-cyan-400 focus:bg-white outline-none transition-all font-serif font-black text-xl uppercase tracking-wider placeholder-slate-200 shadow-inner" placeholder="e.g. Initiate">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" 
                        class="w-full bg-slate-50 border-2 border-slate-200 rounded-[32px] text-slate-700 p-8 outline-none focus:border-cyan-400 focus:bg-white transition-all font-medium placeholder-slate-200 shadow-inner leading-relaxed" placeholder="Detailed directive for this authority level..."></textarea>
                </div>
            </div>
