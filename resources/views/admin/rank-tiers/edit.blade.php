...
@section('title', 'Rekalibrasi Protokol Rank')
...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-6 mb-10">
        ...
        <div>
            <h1 class="text-4xl font-serif font-black text-teal-900 tracking-wide uppercase">Rekalibrasi Tingkat</h1>
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-[0.4em] mt-2 flex items-center gap-2">
                <span class="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.5)]"></span>
                Node Terotorisasi: Rekalibrasi Tingkat {{ $rankTier->slug }}
            </p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.rank-tiers.update', $rankTier) }}" method="POST" class="space-y-10 relative z-10">
            ...
            <div class="space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div>
                        <label class="block text-[10px] font-black text-teal-900/40 uppercase mb-3 tracking-[0.3em] ml-1">Pengenal Slug Rank</label>
