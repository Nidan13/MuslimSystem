            ...
            <div class="space-y-8">
                ...
                <div class="space-y-3">
                    ...
                    <textarea name="summary" rows="3"
                        ...
                        placeholder="Tuliskan intisari/ringkasan singkat dari berita ini... (Tampil di card Landing Page)">{{ old('summary', $headline->summary) }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="flex items-center gap-4 bg-slate-50 p-6 rounded-3xl border border-slate-100">
                        <label class="flex items-center cursor-pointer gap-4">
                            <div class="relative">
                                <input type="checkbox" name="is_active" class="sr-only peer" {{ $headline->is_active ? 'checked' : '' }}>
                    ...
                    <div class="flex items-center gap-4 bg-slate-50 p-6 rounded-3xl border border-slate-100">
                        <label class="flex items-center cursor-pointer gap-4">
                            <div class="relative">
                                <input type="checkbox" name="is_for_user" class="sr-only peer" {{ $headline->is_for_user ? 'checked' : '' }}>
                    ...
                    <div class="flex items-center gap-4 bg-slate-50 p-6 rounded-3xl border border-slate-100">
                        <label class="flex items-center cursor-pointer gap-4">
                            <div class="relative">
                                <input type="checkbox" name="is_for_landing_page" class="sr-only peer" {{ $headline->is_for_landing_page ? 'checked' : '' }}>
                                <div class="w-14 h-8 bg-slate-200 rounded-full peer peer-focus:ring-2 peer-focus:ring-cyan-300 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-1 after:left-1 after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-nu-teal"></div>
                            </div>
