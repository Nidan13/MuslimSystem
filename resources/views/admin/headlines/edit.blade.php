...
<div class="w-full animate-fadeIn">
    ...
    <div class="glass-panel p-10 rounded-[40px] bg-white border-2 border-slate-50 shadow-xl relative overflow-hidden">
        <form action="{{ route('admin.headlines.update', $headline) }}" method="POST" class="space-y-10 relative z-10">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-3">
                    ...
                    <input type="url" name="image_url" value="{{ old('image_url', $headline->image_url) }}"
