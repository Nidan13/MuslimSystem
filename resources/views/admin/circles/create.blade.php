...
@section('title', 'Form Spiritual Covenant')
...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-6 mb-10">
        ...
        <div>
            <h1 class="text-4xl font-serif font-black text-teal-900 tracking-wide uppercase">Form Covenant</h1>
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-[0.4em] mt-2 flex items-center gap-2">
                <span class="w-2 h-2 rounded-full bg-cyan-400 animate-pulse"></span>
                Establishing New Node in the Collective Matrix
            </p>
        </div>
    </div>
            ...
            <div class="space-y-8">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required 
                        class="w-full bg-slate-50 border-2 border-slate-200 rounded-[24px] text-teal-900 p-6 focus:border-cyan-400 focus:bg-white outline-none transition-all font-serif font-black text-xl uppercase tracking-wider placeholder-slate-200 shadow-inner" placeholder="e.g. ORDER OF THE SACRED LIGHT">
                </div>
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="w-full bg-slate-50 border-2 border-dashed border-slate-200 rounded-[32px] p-8 text-center group-hover:border-cyan-400 transition-all shadow-inner">
                            ...
                            <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Select Emblem Vector (JPG, PNG, WEBP)</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="5" 
                        class="w-full bg-slate-50 border-2 border-slate-200 rounded-[32px] text-slate-700 p-8 outline-none focus:border-cyan-400 focus:bg-white transition-all font-medium placeholder-slate-200 shadow-inner leading-relaxed" placeholder="Describe the covenant's divine purpose and bonding protocols..."></textarea>
                </div>
            </div>
            ...
            <div class="pt-6">
                <button type="submit" class="w-full group relative overflow-hidden bg-teal-900 hover:bg-teal-800 py-6 rounded-[24px] font-serif font-black text-white uppercase tracking-[0.3em] shadow-2xl shadow-teal-950/30 transition-all active:scale-[0.99] border-t border-white/10">
                    <span class="relative flex items-center justify-center gap-4">
                        RATIFY COVENANT
                        <i class="fas fa-stamp text-gold-400 icon-glow transition-all group-hover:rotate-12"></i>
                    </span>
                </button>
            </div>
        </form>
