...
<div class="w-full animate-fadeIn">
    <div class="flex items-center gap-6 mb-10">
        ...
        <div>
            <h1 class="text-3xl font-serif font-black text-teal-900 tracking-tight uppercase italic leading-none">Pembentukan <span class="text-cyan-500 font-sans tracking-normal not-italic mx-1">Lingkaran</span> <span class="text-teal-900 font-serif">Baru</span></h1>
            <p class="text-slate-400 text-[10px] font-bold uppercase tracking-[0.3em] mt-2 flex items-center gap-2">
                <span class="w-2 h-2 rounded-full bg-cyan-400 animate-pulse"></span>
                Inisialisasi Node Kolektif Ke Dalam Matriks
            </p>
        </div>
    </div>
