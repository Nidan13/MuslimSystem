...
@section('title', 'Quest Matrix Calibration')
...
<div class="max-w-5xl mx-auto">
    <div class="flex items-center gap-6 mb-10">
        ...
        <div>
            <h1 class="text-4xl font-serif font-black text-teal-900 tracking-wide uppercase">Quest Matrix Calibration</h1>
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-[0.4em] mt-2 flex items-center gap-2">
                <span class="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.5)]"></span>
                Defining Protocol Parameters & Reward Yields
            </p>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div class="col-span-full">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required 
                        ...
                        placeholder="e.g. THE ABYSSAL DEEP">
                </div>
                ...
                <div class="col-span-full">
                    ...
                    <textarea name="description" rows="5" class="w-full bg-slate-50 border-2 border-slate-100 rounded-[28px] text-teal-900 p-8 outline-none focus:border-cyan-400 focus:bg-white transition-all font-serif font-black text-lg shadow-inner placeholder-slate-200" placeholder="State operational objectives..."></textarea>
                </div>
                ...
                <div class="col-span-full grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="p-8 bg-slate-50 rounded-[32px] border-2 border-slate-100">
                        ...
                        <input type="number" name="reward_soul_points" value="100" class="w-full bg-white border-2 border-slate-100 rounded-2xl text-gold-600 p-4 text-center text-3xl font-mono font-black focus:border-gold-400 outline-none transition-all shadow-inner">
                    </div>
                    <div class="p-8 bg-slate-50 rounded-[32px] border-2 border-slate-100">
                        <label class="block text-[10px] font-black text-cyan-500 uppercase mb-4 tracking-[0.3em] text-center">Growth Factor (EXP)</label>
                        <input type="number" name="reward_exp" value="50" class="w-full bg-white border-2 border-slate-100 rounded-2xl text-cyan-600 p-4 text-center text-3xl font-mono font-black focus:border-cyan-400 outline-none transition-all shadow-inner">
                    </div>
                    <div class="p-8 bg-slate-50 rounded-[32px] border-2 border-slate-100">
                        <label class="block text-[10px] font-black text-red-500 uppercase mb-4 tracking-[0.3em] text-center">Fatigue Strain</label>
                        <input type="number" name="penalty_fatigue" value="5" class="w-full bg-white border-2 border-slate-100 rounded-2xl text-red-600 p-4 text-center text-3xl font-mono font-black focus:border-red-400 outline-none transition-all shadow-inner">
                    </div>
                </div>
                ...
                <div class="col-span-full space-y-8 bg-slate-50 p-10 rounded-[40px] border-2 border-slate-100 shadow-inner">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex gap-6">
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <input type="radio" name="schedule_type" value="specific" checked onchange="toggleScheduleFields()" class="w-5 h-5 text-teal-900 focus:ring-cyan-400 border-slate-300">
                            ...
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <input type="radio" name="schedule_type" value="recurring" onchange="toggleScheduleFields()" class="w-5 h-5 text-teal-900 focus:ring-cyan-400 border-slate-300">
                    ...
                    <div id="specific-fields" class="grid grid-cols-2 gap-10 animate-fadeIn">
                        <div>
                            ...
                            <input type="datetime-local" name="starts_at" class="w-full bg-white border-2 border-slate-100 rounded-2xl text-teal-900 p-5 text-sm font-black focus:border-cyan-400 outline-none shadow-sm transition-all">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase mb-3 tracking-[0.3em] ml-1">Expires At</label>
                            <input type="datetime-local" name="expires_at" class="w-full bg-white border-2 border-slate-100 rounded-2xl text-teal-900 p-5 text-sm font-black focus:border-red-400 outline-none shadow-sm transition-all">
                        </div>
                    </div>
                    ...
                    <div id="recurring-fields" class="grid grid-cols-2 gap-10 hidden animate-fadeIn">
                        <div>
                            ...
                            <input type="time" name="start_time" class="w-full bg-white border-2 border-slate-100 rounded-2xl text-teal-900 p-5 text-sm font-black focus:border-cyan-400 outline-none shadow-sm transition-all">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase mb-3 tracking-[0.3em] ml-1">Daily Deactivation</label>
                            <input type="time" name="end_time" class="w-full bg-white border-2 border-slate-100 rounded-2xl text-teal-900 p-5 text-sm font-black focus:border-red-400 outline-none shadow-sm transition-all">
                        </div>
                    </div>
                </div>
            ...
            <div class="pt-10 border-t-2 border-slate-50">
                <button type="submit" class="w-full group relative overflow-hidden bg-teal-900 hover:bg-teal-800 py-8 rounded-[32px] font-serif font-black text-white uppercase tracking-[0.4em] shadow-2xl shadow-teal-950/30 transition-all active:scale-[0.98] border-t border-white/10">
                    <span class="relative flex items-center justify-center gap-4">
                        RATIFY OPERATIONAL PROTOCOL
                        <i class="fas fa-file-signature text-cyan-400 icon-glow transition-all group-hover:scale-125"></i>
                    </span>
                </button>
            </div>
        </form>
