...
@section('title', 'Inisialisasi Klasifikasi Gerbang')
...
<div class="max-w-4xl mx-auto animate-fadeIn">
    ...
    <div class="flex items-center gap-8 mb-12">
        ...
        <div>
            <h1 class="text-4xl font-serif font-black text-teal-900 tracking-tight uppercase">Inisialisasi Rift</h1>
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-[0.4em] mt-2 flex items-center gap-2">
                <span class="w-2 h-2 rounded-full bg-cyan-400 animate-pulse shadow-[0_0_10px_#22d3ee]"></span>
                Definisikan Klasifikasi Baru & Kapasitas Hunter
            </p>
        </div>
    </div>
