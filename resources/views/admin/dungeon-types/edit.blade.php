            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="slug" value="{{ old('slug', $dungeonType->slug) }}" required
                ...
                <!-- Max Participants -->
                <div class="space-y-4">
                    <label class="text-[10px] font-black text-gold-600 uppercase tracking-[0.3em] ml-2 block">Kapasitas Maksimum (Hunter)</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none">
                            <i class="fas fa-users-gear text-slate-300 group-focus-within:text-gold-500 transition-colors"></i>
                        </div>
                        <input type="number" name="max_participants" value="{{ old('max_participants', $dungeonType->max_participants) }}" required
