                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-wrap items-center justify-center gap-4">
                        ...
                        {categories.map(cat => (
                            ...
                            >
                                {cat.name} <span className="ml-1 opacity-40">({cat.headlines_count || 0})</span>
                            </Link>
                        ))}
                    </div>
                </div>
                        ...
                        <div className="mt-20 flex justify-center gap-3">
                            {news.links.map((link, i) => 
                                link.url ? (
                                    ...
                                    <span
                                        key={i}
                                        className="px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest bg-slate-50 text-slate-300 border border-slate-100 cursor-not-allowed"
                                        dangerouslySetInnerHTML={{ __html: link.label }}
                                    />
                                )
                            )}
