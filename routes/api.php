...
Route::get('/categories', [\App\Http\Controllers\User\CategoryController::class , 'index']);
    ...
    Route::middleware(\App\Http\Middleware\ActiveUser::class)->group(function () {
            ...
            Route::prefix('daily-tasks')->group(function () {
                ...
                Route::prefix('donations')->group(function () {
                    ...
                    Route::put('/campaign/{id}', [\App\Http\Controllers\User\DonationController::class , 'updateCampaign']);
                    Route::post('/report/{campaignId}', [\App\Http\Controllers\User\DonationController::class , 'storeReport']);
                    Route::put('/report/{id}', [\App\Http\Controllers\User\DonationController::class , 'updateReport']);
                }
                );
            }
            );
